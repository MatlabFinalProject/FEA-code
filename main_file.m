...
crossCell = inputdlg('What is the cross section area of your trusses (m^2)'); % don't need ' ' for this
cross = crossCell{1};
...
% outputting the stress of each element
for ii = 1:ne
      fprintf('Element %d has a stress of %d (Pascals) \n', ii, stress(ii));
end
